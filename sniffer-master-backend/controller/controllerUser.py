...
def crear_usuario():
    ...
    if registro:
        ...
        response_data = {'mensaje': 'El correo ya está registrado ', "results": False}
        return jsonify(response_data), 409
    
    # Insertar los datos en la tabla
    cursor.execute('INSERT INTO usuarios (correo, contraseña, nombre_completo, telefono) VALUES (%s, %s, %s, %s, %s)', (correo, contraseña, nombre_completo, telefono, pin))
    conexion.commit()
    
    # Responder con un mensaje de éxito
   # return 'Usuario creado correctamente'
    response_data = {'mensaje': 'Usuario creado correctamente', "results": True}
